...
var BASE_PACKAGE = {
  ...
  readme: 'README.md',
  dependencies: {
    'tuxcore-lib': '^' + bitcore.version,
    'tuxcore-node': version
    // 'tuxcore-lib': 'tuxcoin-project/tuxcore-lib#segwit',
    // 'tuxcore-node': 'tuxcoin-project/tuxcore-node#master'
  }
};
...
function createConfigDirectory(options, configDir, isGlobal, done) {
  mkdirp(configDir, function(err) {
    ...
    try {
      fs.writeFileSync(configDir + '/tuxcore-node.json', configJSON);
      if (!isGlobal) {
 ...
 * @param {String} options.dirname - The name of the tuxcore node configuration directory
