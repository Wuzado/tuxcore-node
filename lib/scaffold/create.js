...
var BASE_PACKAGE = {
  ...
  readme: 'README.md',
  dependencies: {
    'garlicore-lib': '^' + bitcore.version,
    'garlicore-node': version
    // 'garlicore-lib': 'garlicoin-project/garlicore-lib#segwit',
    // 'garlicore-node': 'garlicoin-project/garlicore-node#master'
  }
};
...
function createConfigDirectory(options, configDir, isGlobal, done) {
  mkdirp(configDir, function(err) {
    ...
    try {
      fs.writeFileSync(configDir + '/garlicore-node.json', configJSON);
      if (!isGlobal) {
 ...
 * @param {String} options.dirname - The name of the garlicore node configuration directory
