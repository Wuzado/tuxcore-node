...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `tuxcore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ tuxcore-node add insight-tux-ui');
      console.log('    $ tuxcore-node add insight-tux-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ tuxcore-node remove insight-tux-ui');
      console.log('    $ tuxcore-node remove insight-tux-api');
      console.log();
    });
