...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .action(function(services){
      ...
      console.log();
      console.log('    $ tuxcore-node add wallet-service');
      console.log('    $ tuxcore-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ tuxcore-node remove wallet-service');
      console.log('    $ tuxcore-node remove insight-api');
      console.log();
    });
