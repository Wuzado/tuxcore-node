...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `garlicore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ garlicore-node add wallet-service');
      console.log('    $ garlicore-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ garlicore-node remove wallet-service');
      console.log('    $ garlicore-node remove insight-api');
      console.log();
    });
